...
exports.default = {
  ...
  methods: {
    fetch: function fetch() {
      ...
      this.$http.get('/pager?pageIndex=' + this.pageIndex + '&pageSize=' + this.pageSize).then(function (res) {
        console.log('res', res);
...
if(content.locals) module.exports = content.locals;
// add CSS to SSR context
__webpack_require__(15)("7877e353", content, true);
...
var _elementUi = __webpack_require__(116);
...
exports.default = _app2.default.init((0, _extends3.default)({}, _element2.default));
module.exports = exports['default'];
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _c('p'), _vm._v(" "), _c('el-table', {
    staticStyle: {
      "width": "100%"
    },
    attrs: {
